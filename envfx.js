(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["envfx"],{
...
/*!*******************************************************************************************************!*\
  ...
  \*******************************************************************************************************/
/*! exports provided: EnvironmentEffects, default */
...
function EnvironmentEffects() {
  ...
  const dofBk = Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])([10]);
  Object(_utils_useRefFrame__WEBPACK_IMPORTED_MODULE_4__["useRefFrame"])(([effect], [{
    clock
  }]) => {
    const t = clock.getElapsedTime(); // debugger;

    dofBk.current[0] = effect.bokehScale = ((effect.bokehScale || 0) + (1 + Math.atan(t * -0.2 * (t - 2) + 0.5 * Math.sin(t * 2)) / _constants__WEBPACK_IMPORTED_MODULE_6__["PI"]._1_2) * 10 + 0.0) * 0.5;
  }, [dof]); // useLayoutEffect(() => {
...
/* harmony default export */ __webpack_exports__["default"] = (EnvironmentEffects);

/***/ }),

/***/ "../../../node_modules/@react-three/postprocessing/dist/index.js":
/*!*****************************************************************************************************!*\
  !*** /Users/coryhall/Code/FL/anonymous.club/node_modules/@react-three/postprocessing/dist/index.js ***!
  \*****************************************************************************************************/
/*! exports provided: Bloom, BrightnessContrast, ChromaticAberration, ColorAverage, ColorDepth, Depth, DepthOfField, DotScreen, EffectComposer, EffectComposerContext, Glitch, GodRays, Grid, HueSaturation, LUT, Noise, Outline, Pixelation, SMAA, SSAO, Scanline, SelectiveBloom, Sepia, ShockWave, Texture, ToneMapping, Vignette */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Bloom", function() { return ee; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BrightnessContrast", function() { return te; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChromaticAberration", function() { return ne; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorAverage", function() { return re; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorDepth", function() { return ie; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Depth", function() { return oe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthOfField", function() { return se; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DotScreen", function() { return ae; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EffectComposer", function() { return ce; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EffectComposerContext", function() { return le; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Glitch", function() { return ue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GodRays", function() { return de; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Grid", function() { return me; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HueSaturation", function() { return fe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LUT", function() { return Ce; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Noise", function() { return pe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Outline", function() { return he; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Pixelation", function() { return ge; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAA", function() { return ve; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SSAO", function() { return ye; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Scanline", function() { return be; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectiveBloom", function() { return we; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Sepia", function() { return Ee; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShockWave", function() { return je; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Texture", function() { return Se; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ToneMapping", function() { return xe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Vignette", function() { return Te; });
/* harmony import */ var postprocessing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! postprocessing */ "../../../node_modules/@react-three/postprocessing/node_modules/postprocessing/build/postprocessing.esm.js");
...
const X=(t,n=postprocessing__WEBPACK_IMPORTED_MODULE_0__["BlendFunction"].NORMAL)=>Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({blendFunction:e,opacity:r,...i},o){const l=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new t(i)),[i]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"])((()=>{l.blendMode.blendFunction=e||n,void 0!==r&&(l.blendMode.opacity.value=r)}),[e,l.blendMode,r]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:o,object:l,dispose:null})})),Z=(e,t)=>{const n=e[t];return Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>{if(n instanceof three__WEBPACK_IMPORTED_MODULE_2__["Vector2"])return(new three__WEBPACK_IMPORTED_MODULE_2__["Vector2"]).set(n.x,n.y);if(Array.isArray(n)){const[e,t]=n;return(new three__WEBPACK_IMPORTED_MODULE_2__["Vector2"]).set(e,t)}}),[n])},$=()=>{try{const e=document.createElement("canvas");return!(!window.WebGL2RenderingContext||!e.getContext("webgl2"))}catch(e){return!1}},ee=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["BloomEffect"],postprocessing__WEBPACK_IMPORTED_MODULE_0__["BlendFunction"].SCREEN),te=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["BrightnessContrastEffect"]),ne=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function(e,t){const n=Z(e,"offset"),i=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["ChromaticAberrationEffect"]({...e,offset:n})),[n,e]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:t,object:i,dispose:null})})),re=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({blendFunction:t=postprocessing__WEBPACK_IMPORTED_MODULE_0__["BlendFunction"].NORMAL},n){const r=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["ColorAverageEffect"](t)),[t]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:n,object:r,dispose:null})})),ie=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["ColorDepthEffect"]),oe=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["DepthEffect"]),le=Object(react__WEBPACK_IMPORTED_MODULE_1__["createContext"])(null),ce=react__WEBPACK_IMPORTED_MODULE_1___default.a.memo(Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((({children:e,camera:t,scene:n,renderPriority:r=1,autoClear:i=!0,depthBuffer:o,disableNormalPass:l=!0,stencilBuffer:d,multisampling:m=0,frameBufferType:f},p)=>{const{gl:h,scene:g,camera:b,size:w}=Object(_react_three_fiber__WEBPACK_IMPORTED_MODULE_3__["useThree"])();n=n||g,t=t||b;const[E,y]=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>{const e=new postprocessing__WEBPACK_IMPORTED_MODULE_0__["EffectComposer"](h,{depthBuffer:o,stencilBuffer:d,multisampling:$()?m:0,frameBufferType:f});e.addPass(new postprocessing__WEBPACK_IMPORTED_MODULE_0__["RenderPass"](n,t));const r=l?null:new postprocessing__WEBPACK_IMPORTED_MODULE_0__["NormalPass"](n,t);return r&&e.addPass(r),[e,r]}),[t,h,o,d,m,f,n,l]);Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])((()=>null==E?void 0:E.setSize(w.width,w.height)),[E,w]),Object(_react_three_fiber__WEBPACK_IMPORTED_MODULE_3__["useFrame"])(((e,t)=>(h.autoClear=i,void E.render(t))),r);const v=Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])(null);Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])((()=>{let e;return v.current&&v.current.__r3f&&E&&(e=new postprocessing__WEBPACK_IMPORTED_MODULE_0__["EffectPass"](t,...v.current.__r3f.objects),E.addPass(e),e.renderToScreen=!0),()=>{e&&(null==E||E.removePass(e))}}),[E,e,t]);const S=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>({composer:E,normalPass:y,camera:t,scene:n})),[E,y,t,n]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useImperativeHandle"])(p,(()=>E),[E]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(le.Provider,{value:S},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("group",{ref:v},e))}))),se=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({target:e,depthTexture:t,...n},r){const{camera:i}=Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(le),o=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["DepthOfFieldEffect"](i,n)),[i,n]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"])((()=>{if(e){const t=e instanceof three__WEBPACK_IMPORTED_MODULE_2__["Vector3"]?(new three__WEBPACK_IMPORTED_MODULE_2__["Vector3"]).set(e.x,e.y,e.z):(new three__WEBPACK_IMPORTED_MODULE_2__["Vector3"]).set(e[0],e[1],e[2]);o.target=t}t&&o.setDepthTexture(t.texture,t.packing)}),[e,t,o]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:r,object:o,dispose:null})})),ae=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["DotScreenEffect"]),ue=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({active:e=!0,...t},n){const r=Z(t,"delay"),i=Z(t,"duration"),o=Z(t,"strength"),l=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["GlitchEffect"]({...t,delay:r,duration:i,strength:o})),[r,i,t,o]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"])((()=>{l.mode=e?t.mode||postprocessing__WEBPACK_IMPORTED_MODULE_0__["GlitchMode"].SPORADIC:postprocessing__WEBPACK_IMPORTED_MODULE_0__["GlitchMode"].DISABLED}),[e,l,t.mode]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:n,object:l,dispose:null})})),de=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function(e,t){const{camera:n}=Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(le),r=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["GodRaysEffect"](n,e.sun,e)),[n,e]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:t,object:r,dispose:null})})),me=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({size:e,...t},n){const r=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["GridEffect"](t)),[t]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"])((()=>{e&&r.setSize(e.width,e.height)}),[r,e]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:n,object:r,dispose:null})})),fe=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["HueSaturationEffect"]),pe=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["NoiseEffect"],postprocessing__WEBPACK_IMPORTED_MODULE_0__["BlendFunction"].COLOR_DODGE),he=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({selection:e=[],selectionLayer:t=10,blendFunction:n,patternTexture:r,edgeStrength:i,pulseSpeed:o,visibleEdgeColor:l,hiddenEdgeColor:c,width:s,height:a,kernelSize:u,blur:d,xRay:m,...f},p){const{scene:h,camera:g}=Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(le),b=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["OutlineEffect"](h,g,{blendFunction:n,patternTexture:r,edgeStrength:i,pulseSpeed:o,visibleEdgeColor:l,hiddenEdgeColor:c,width:s,height:a,kernelSize:u,blur:d,xRay:m})),[n,d,g,i,a,c,u,r,o,h,l,s,m]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])((()=>{b.clearSelection(),b.setSelection(Array.isArray(e)?e.map((e=>e.current)):[e.current])}),[b,e]),Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])((()=>{b.selectionLayer=t}),[b,t]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:p,object:b,dispose:null})})),ge=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({granularity:e=5},t){const n=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["PixelationEffect"](e)),[e]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:t,object:n,dispose:null})})),be=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["ScanlineEffect"],postprocessing__WEBPACK_IMPORTED_MODULE_0__["BlendFunction"].OVERLAY),we=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({selection:t=[],selectionLayer:n=10,lights:r=[],luminanceThreshold:i,luminanceSmoothing:o,intensity:l,width:c,height:s,kernelSize:a},u){0===r.length&&console.warn("SelectiveBloom requires lights to work.");const{scene:d,camera:m}=Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(le),f=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["SelectiveBloomEffect"](d,m,{blendFunction:postprocessing__WEBPACK_IMPORTED_MODULE_0__["BlendFunction"].SCREEN,luminanceThreshold:i,luminanceSmoothing:o,intensity:l,width:c,height:s,kernelSize:a})),[m,s,l,a,o,i,d,c]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])((()=>{f.selection.set(Array.isArray(t)?t.map((e=>e.current)):[t.current])}),[f,t]),Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])((()=>{f.selection.layer=n}),[f,n]),Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])((()=>(r.forEach((e=>((e,t)=>{e.current&&e.current.layers.enable(t.selection.layer)})(e,f))),()=>r.forEach((e=>((e,t)=>{e.current&&e.current.layers.disable(t.selection.layer)})(e,f))))),[f,r,n]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:u,object:f,dispose:null})})),Ee=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["SepiaEffect"]),ye=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function(t,n){const{camera:r,normalPass:i}=Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(le),o=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>null===i?(console.error("Please enable the NormalPass in the EffectComposer in order to use SSAO."),null):new postprocessing__WEBPACK_IMPORTED_MODULE_0__["SSAOEffect"](r,i.renderTarget.texture,{blendFunction:postprocessing__WEBPACK_IMPORTED_MODULE_0__["BlendFunction"].MULTIPLY,samples:30,rings:4,distanceThreshold:1,distanceFalloff:0,rangeThreshold:.5,rangeFalloff:.1,luminanceInfluence:.9,radius:20,scale:.5,bias:.5,...t})),[r,i,t]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:n,object:o,dispose:null})})),ve=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({preset:e=postprocessing__WEBPACK_IMPORTED_MODULE_0__["SMAAPreset"].HIGH,edgeDetectionMode:t=postprocessing__WEBPACK_IMPORTED_MODULE_0__["EdgeDetectionMode"].COLOR},n){const r=Object(_react_three_fiber__WEBPACK_IMPORTED_MODULE_3__["useLoader"])(postprocessing__WEBPACK_IMPORTED_MODULE_0__["SMAAImageLoader"],""),i=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["SMAAEffect"](...r,e,t)),[r,e,t]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:n,object:i,dispose:null})})),Se=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({textureSrc:e,texture:t,...n},r){const i=Object(_react_three_fiber__WEBPACK_IMPORTED_MODULE_3__["useLoader"])(three__WEBPACK_IMPORTED_MODULE_2__["TextureLoader"],e);Object(react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"])((()=>{i.encoding=three__WEBPACK_IMPORTED_MODULE_2__["sRGBEncoding"],i.wrapS=i.wrapT=three__WEBPACK_IMPORTED_MODULE_2__["RepeatWrapping"]}),[i]);const o=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["TextureEffect"]({...n,texture:i||t})),[n,i,t]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:r,object:o,dispose:null})})),xe=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["ToneMappingEffect"]),Te=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["VignetteEffect"]),je=X(postprocessing__WEBPACK_IMPORTED_MODULE_0__["ShockWaveEffect"]),Ce=Object(react__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])((function({lut:e,tetrahedralInterpolation:t,...n},r){const i=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])((()=>new postprocessing__WEBPACK_IMPORTED_MODULE_0__["LUTEffect"](e,n)),[e,n]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useLayoutEffect"])((()=>{e&&i.setLUT(e),t&&i.setTetrahedralInterpolationEnabled(t)}),[i,e,t]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("primitive",{ref:r,object:i,dispose:null})}));


/***/ }),

/***/ "../../../node_modules/@react-three/postprocessing/node_modules/postprocessing/build/postprocessing.esm.js":
/*!***********************************************************************************************************************************************!*\
  !*** /Users/coryhall/Code/FL/anonymous.club/node_modules/@react-three/postprocessing/node_modules/postprocessing/build/postprocessing.esm.js ***!
  \***********************************************************************************************************************************************/
/*! exports provided: AdaptiveLuminanceMaterial, AdaptiveLuminancePass, BlendFunction, BlendMode, BloomEffect, BlurPass, BokehEffect, BokehMaterial, BrightnessContrastEffect, ChromaticAberrationEffect, CircleOfConfusionMaterial, ClearMaskPass, ClearPass, ColorAverageEffect, ColorChannel, ColorDepthEffect, ColorEdgesMaterial, ConvolutionMaterial, CopyMaterial, DepthComparisonMaterial, DepthCopyMaterial, DepthCopyMode, DepthDownsamplingMaterial, DepthDownsamplingPass, DepthEffect, DepthMaskMaterial, DepthOfFieldEffect, DepthPass, DepthPickingPass, DepthSavePass, Disposable, DotScreenEffect, EdgeDetectionMaterial, EdgeDetectionMode, Effect, EffectAttribute, EffectComposer, EffectMaterial, EffectPass, GammaCorrectionEffect, GlitchEffect, GlitchMode, GodRaysEffect, GodRaysMaterial, GridEffect, HueSaturationEffect, Initializable, KernelSize, LUT3dlLoader, LUTCubeLoader, LUTEffect, LUTOperation, LambdaPass, LookupTexture3D, LuminanceMaterial, LuminancePass, MaskFunction, MaskMaterial, MaskPass, NoiseEffect, NoiseTexture, NormalPass, OutlineEdgesMaterial, OutlineEffect, OutlineMaterial, OverrideMaterialManager, Pass, PixelationEffect, PredicationMode, RawImageData, RealisticBokehEffect, RenderPass, Resizable, Resizer, SMAAAreaImageData, SMAAEffect, SMAAImageGenerator, SMAAImageLoader, SMAAPreset, SMAASearchImageData, SMAAWeightsMaterial, SSAOEffect, SSAOMaterial, SavePass, ScanlineEffect, Section, Selection, SelectiveBloomEffect, SepiaEffect, ShaderPass, ShockWaveEffect, TetrahedralUpscaler, TextureEffect, ToneMappingEffect, ToneMappingMode, VignetteEffect, WebGLExtension */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdaptiveLuminanceMaterial", function() { return AdaptiveLuminanceMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdaptiveLuminancePass", function() { return AdaptiveLuminancePass; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BloomEffect", function() { return BloomEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BlurPass", function() { return BlurPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BokehEffect", function() { return BokehEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BokehMaterial", function() { return BokehMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BrightnessContrastEffect", function() { return BrightnessContrastEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChromaticAberrationEffect", function() { return ChromaticAberrationEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CircleOfConfusionMaterial", function() { return CircleOfConfusionMaterial; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorAverageEffect", function() { return ColorAverageEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorChannel", function() { return ColorChannel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorDepthEffect", function() { return ColorDepthEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorEdgesMaterial", function() { return ColorEdgesMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConvolutionMaterial", function() { return ConvolutionMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CopyMaterial", function() { return CopyMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthComparisonMaterial", function() { return DepthComparisonMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthCopyMaterial", function() { return DepthCopyMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthCopyMode", function() { return DepthCopyMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthDownsamplingMaterial", function() { return DepthDownsamplingMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthDownsamplingPass", function() { return DepthDownsamplingPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthEffect", function() { return DepthEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthMaskMaterial", function() { return DepthMaskMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthOfFieldEffect", function() { return DepthOfFieldEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthPass", function() { return DepthPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthPickingPass", function() { return DepthPickingPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepthSavePass", function() { return DepthSavePass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Disposable", function() { return Disposable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DotScreenEffect", function() { return DotScreenEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EdgeDetectionMaterial", function() { return EdgeDetectionMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EdgeDetectionMode", function() { return EdgeDetectionMode; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EffectMaterial", function() { return EffectMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EffectPass", function() { return EffectPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GammaCorrectionEffect", function() { return GammaCorrectionEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GlitchEffect", function() { return GlitchEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GlitchMode", function() { return GlitchMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GodRaysEffect", function() { return GodRaysEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GodRaysMaterial", function() { return GodRaysMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GridEffect", function() { return GridEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HueSaturationEffect", function() { return HueSaturationEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Initializable", function() { return Initializable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KernelSize", function() { return KernelSize; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LUTEffect", function() { return LUTEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LUTOperation", function() { return LUTOperation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LambdaPass", function() { return LambdaPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LookupTexture3D", function() { return LookupTexture3D; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LuminanceMaterial", function() { return LuminanceMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LuminancePass", function() { return LuminancePass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaskFunction", function() { return MaskFunction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaskMaterial", function() { return MaskMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaskPass", function() { return MaskPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NoiseEffect", function() { return NoiseEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NoiseTexture", function() { return NoiseTexture; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NormalPass", function() { return NormalPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OutlineEdgesMaterial", function() { return OutlineEdgesMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OutlineEffect", function() { return OutlineEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OutlineMaterial", function() { return OutlineMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OverrideMaterialManager", function() { return OverrideMaterialManager; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Pass", function() { return Pass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PixelationEffect", function() { return PixelationEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PredicationMode", function() { return PredicationMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RawImageData", function() { return RawImageData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RealisticBokehEffect", function() { return RealisticBokehEffect; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAAAreaImageData", function() { return SMAAAreaImageData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAAEffect", function() { return SMAAEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAAImageGenerator", function() { return SMAAImageGenerator; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAAImageLoader", function() { return SMAAImageLoader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAAPreset", function() { return SMAAPreset; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAASearchImageData", function() { return SMAASearchImageData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SMAAWeightsMaterial", function() { return SMAAWeightsMaterial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SSAOEffect", function() { return SSAOEffect; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScanlineEffect", function() { return ScanlineEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Section", function() { return Section; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Selection", function() { return Selection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectiveBloomEffect", function() { return SelectiveBloomEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SepiaEffect", function() { return SepiaEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShaderPass", function() { return ShaderPass; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShockWaveEffect", function() { return ShockWaveEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TetrahedralUpscaler", function() { return TetrahedralUpscaler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextureEffect", function() { return TextureEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ToneMappingEffect", function() { return ToneMappingEffect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ToneMappingMode", function() { return ToneMappingMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VignetteEffect", function() { return VignetteEffect; });
...
var BokehMaterial = class extends three__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"] {
  ...
  generateKernel() {
    ...
    const kernel16 = [];
    for (let i = 0; i < 128; ) {
      kernel64.push(new three__WEBPACK_IMPORTED_MODULE_0__["Vector4"](points64[i++], points64[i++], points64[i++], points64[i++]));
    }
    for (let i = 0; i < 32; ) {
      kernel16.push(new three__WEBPACK_IMPORTED_MODULE_0__["Vector4"](points16[i++], points16[i++], points16[i++], points16[i++]));
    }
  ...
  constructor(camera) {
    super({
      ...
      uniforms: {
        ...
        focalLength: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](0),
...
// src/materials/ColorEdgesMaterial.js
var ColorEdgesMaterial = class extends three__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"] {
...
// src/materials/ConvolutionMaterial.js
var ConvolutionMaterial = class extends three__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"] {
  constructor(texelSize = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]()) {
    super({
...
var DepthComparisonMaterial = class extends three__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"] {
  constructor(depthTexture = null, camera) {
    super({
      ...
      uniforms: {
        depthBuffer: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](depthTexture),
        cameraNear: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](0.3),
        cameraFar: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](1e3)
      },
...
var DepthCopyMaterial = class extends three__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"] {
  constructor() {
    super({
      ...
      uniforms: {
        depthBuffer: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](null),
        screenPosition: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]())
      },
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        bias0: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](0),
        bias1: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](0)
      },
    ...
    this.setDepthMode(three__WEBPACK_IMPORTED_MODULE_0__["LessDepth"]);
  }
  get keepFar() {
  ...
  constructor(colorOutput = false, luminanceRange = null) {
    ...
    super({
      ...
      uniforms: {
        ...
        range: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](useRange ? luminanceRange : new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]())
      },
  ...
  constructor(camera) {
    super({
      ...
      uniforms: {
        ...
        texelSize: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]()),
        cameraNear: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](0),
        cameraFar: new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](0),
...
var dummyCamera = new three__WEBPACK_IMPORTED_MODULE_0__["Camera"]();
var geometry = null;
...
var Pass = class {
  ...
  setFullscreenMaterial(material) {
    ...
    if (screen !== null) {
      ...
      screen = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](getFullscreenTriangle(), material);
  ...
  dispose() {
    ...
    for (const key of Object.keys(this)) {
      ...
      if (property !== null && typeof property.dispose === "function") {
        if (property instanceof three__WEBPACK_IMPORTED_MODULE_0__["Scene"]) {
          continue;
        }
        this[key].dispose();
      }
...
var SavePass = class extends Pass {
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (!alpha && frameBufferType === three__WEBPACK_IMPORTED_MODULE_0__["UnsignedByteType"]) {
      this.renderTarget.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
    }
...
var Resizer = class {
  constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
    ...
    this.base = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](1, 1);
    this.target = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](width, height);
    this.s = scale;
  }
  get scale() {
    return this.s;
...
var BlurPass = class extends Pass {
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (!alpha && frameBufferType === three__WEBPACK_IMPORTED_MODULE_0__["UnsignedByteType"]) {
      this.renderTargetA.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
      this.renderTargetB.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
    }
    if (frameBufferType !== void 0) {
  ...
  constructor({
    ...
    if (this.renderTarget === void 0) {
      this.renderTarget = new three__WEBPACK_IMPORTED_MODULE_0__["WebGLRenderTarget"](1, 1, {
        minFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"],
        magFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"],
        format: colorOutput ? three__WEBPACK_IMPORTED_MODULE_0__["RGBAFormat"] : three__WEBPACK_IMPORTED_MODULE_0__["LuminanceFormat"],
        stencilBuffer: false,
        depthBuffer: false
      });
...
var EffectComposer = class {
  ...
  get multisampling() {
    return this.inputBuffer instanceof three__WEBPACK_IMPORTED_MODULE_0__["WebGLMultisampleRenderTarget"] ? this.inputBuffer.samples : 0;
  }
  ...
  replaceRenderer(renderer, updateDOM = true) {
    ...
    if (oldRenderer !== null && oldRenderer !== renderer) {
      const oldSize = oldRenderer.getSize(new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]());
      const newSize = renderer.getSize(new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]());
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    const size = this.renderer.getDrawingBufferSize(new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]());
    const alpha = this.renderer.getContext().getContextAttributes().alpha;
    const options = {
      format: !alpha && type === three__WEBPACK_IMPORTED_MODULE_0__["UnsignedByteType"] ? three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"] : three__WEBPACK_IMPORTED_MODULE_0__["RGBAFormat"],
      minFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"],
      magFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"],
      stencilBuffer,
      depthBuffer,
    ...
    const renderTarget = multisampling > 0 ? new three__WEBPACK_IMPORTED_MODULE_0__["WebGLMultisampleRenderTarget"](size.width, size.height, options) : new three__WEBPACK_IMPORTED_MODULE_0__["WebGLRenderTarget"](size.width, size.height, options);
    if (multisampling > 0) {
...
var ChromaticAberrationEffect = class extends Effect {
  constructor({ blendFunction = BlendFunction.NORMAL, offset = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](1e-3, 5e-4) } = {}) {
...
var DepthOfFieldEffect = class extends Effect {
  constructor(camera, {
    ...
    this.renderTargetCoC.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (!alpha && frameBufferType === three__WEBPACK_IMPORTED_MODULE_0__["UnsignedByteType"]) {
      this.renderTargetNear.texture.type = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
    }
    if (frameBufferType !== void 0) {
      this.renderTarget.texture.type = frameBufferType;
...
function getNoise(size, format, type) {
  const channels = new Map([
    ...
    [three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"], 3],
...
var GlitchEffect = class extends Effect {
  constructor({
    ...
    super("GlitchEffect", shader_default57, {
      ...
      uniforms: new Map([
        ...
        ["seed", new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]())],
  ...
  setPerturbationMap(map) {
    ...
    map.minFilter = map.magFilter = three__WEBPACK_IMPORTED_MODULE_0__["NearestFilter"];
    map.wrapS = map.wrapT = three__WEBPACK_IMPORTED_MODULE_0__["RepeatWrapping"];
    map.generateMipmaps = false;
    this.uniforms.get("perturbationMap").value = map;
  }
  generatePerturbationMap(size = 64) {
    const map = new NoiseTexture(size, size, three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"]);
    map.name = tag;
    return map;
  }
  update(renderer, inputBuffer, deltaTime) {
...
var GodRaysEffect = class extends Effect {
  constructor(camera, lightSource, {
    ...
    this.renderPassLight.getClearPass().overrideClearColor = new three__WEBPACK_IMPORTED_MODULE_0__["Color"](0);
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (!alpha && frameBufferType === three__WEBPACK_IMPORTED_MODULE_0__["UnsignedByteType"]) {
      this.renderTargetA.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
      this.renderTargetB.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
      this.renderTargetLight.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
    }
    if (frameBufferType !== void 0) {
      this.renderTargetA.texture.type = frameBufferType;
      this.renderTargetB.texture.type = frameBufferType;
...
var LookupTexture3D = class extends three__WEBPACK_IMPORTED_MODULE_0__["DataTexture3D"] {
  constructor(data, size) {
    super(data, size, size, size);
    this.type = three__WEBPACK_IMPORTED_MODULE_0__["FloatType"];
    this.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
    this.encoding = three__WEBPACK_IMPORTED_MODULE_0__["LinearEncoding"];
  ...
  applyLUT(lut) {
    ...
    } else if (lut.format !== three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"] || this.format !== three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"]) {
  ...
  convertLinearToSRGB() {
    ...
    if (this.type === three__WEBPACK_IMPORTED_MODULE_0__["FloatType"]) {
      const stride = this.format === three__WEBPACK_IMPORTED_MODULE_0__["RGBAFormat"] ? 4 : 3;
      for (let i = 0, l = data.length; i < l; i += stride) {
        c.fromArray(data, i).convertLinearToSRGB().toArray(data, i);
      }
      this.encoding = three__WEBPACK_IMPORTED_MODULE_0__["sRGBEncoding"];
      this.needsUpdate = true;
    } else {
  ...
  convertToRGBA() {
    if (this.format === three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"]) {
      const size = this.image.width;
      const rgbData = this.image.data;
      const rgbaData = new rgbData.constructor(size ** 3 * 4);
      const maxValue = this.type === three__WEBPACK_IMPORTED_MODULE_0__["FloatType"] ? 1 : 255;
...
var LUTEffect = class extends Effect {
  constructor(lut, {
    ...
    this.inputEncoding = three__WEBPACK_IMPORTED_MODULE_0__["sRGBEncoding"];
    this.outputEncoding = this.inputEncoding;
    this.setInputEncoding(three__WEBPACK_IMPORTED_MODULE_0__["sRGBEncoding"]);
    this.setLUT(lut);
  }
  getOutputEncoding() {
  ...
  setInputEncoding(value) {
    ...
    if (lut !== null) {
      this.outputEncoding = lut.encoding === three__WEBPACK_IMPORTED_MODULE_0__["LinearEncoding"] ? value : lut.encoding;
  ...
  setLUT(lut) {
    ...
    if (this.getLUT() !== lut) {
      ...
      if (lut.type === three__WEBPACK_IMPORTED_MODULE_0__["FloatType"] || lut.type === three__WEBPACK_IMPORTED_MODULE_0__["HalfFloatType"]) {
        defines.set("LUT_PRECISION_HIGH", "1");
      }
      if (image.width > image.height) {
        defines.set("LUT_STRIP_HORIZONTAL", "1");
      } else if (lut instanceof three__WEBPACK_IMPORTED_MODULE_0__["DataTexture3D"]) {
  ...
  configureTetrahedralInterpolation() {
    ...
    if (this.tetrahedralInterpolation && lut !== null) {
      if (lut instanceof three__WEBPACK_IMPORTED_MODULE_0__["DataTexture3D"]) {
  ...
  constructor(scene, camera, {
    ...
    super("OutlineEffect", shader_default63, {
      uniforms: new Map([
        ...
        ["patternScale", new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](1)],
...
var PixelationEffect = class extends Effect {
  constructor(granularity = 30) {
    super("PixelationEffect", shader_default65, {
      uniforms: new Map([
        ["active", new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](false)],
        ["d", new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]())]
      ])
    });
    this.resolution = new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"]();
...
var v2 = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
var ab = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
var ShockWaveEffect = class extends Effect {
  constructor(camera, epicenter = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"](), {
    speed = 2,
    maxRadius = 1,
    waveSize = 0.2,
    amplitude = 0.05
...
var SelectiveBloomEffect = class extends BloomEffect {
  constructor(scene, camera, options) {
    ...
    depthMaskMaterial.defines.DEPTH_PACKING_1 = three__WEBPACK_IMPORTED_MODULE_0__["RGBADepthPacking"].toFixed(0);
    depthMaskMaterial.setDepthMode(three__WEBPACK_IMPORTED_MODULE_0__["EqualDepth"]);
  ...
  get inverted() {
    return this.depthMaskMaterial.getDepthMode() === three__WEBPACK_IMPORTED_MODULE_0__["NotEqualDepth"];
  }
  set inverted(value) {
    this.depthMaskMaterial.setDepthMode(value ? three__WEBPACK_IMPORTED_MODULE_0__["NotEqualDepth"] : three__WEBPACK_IMPORTED_MODULE_0__["EqualDepth"]);
  }
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    this.depthMaskPass.initialize(renderer, alpha, frameBufferType);
    if (!alpha && frameBufferType === three__WEBPACK_IMPORTED_MODULE_0__["UnsignedByteType"]) {
      this.renderTargetMasked.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
    }
    if (frameBufferType !== void 0) {
      this.renderTargetMasked.texture.type = frameBufferType;
    }
...
var SMAAEffect = class extends Effect {
  constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
    ...
    this.renderTargetWeights.texture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBAFormat"];
    this.uniforms.get("weightMap").value = this.renderTargetWeights.texture;
    this.clearPass = new ClearPass(true, false, false);
    this.clearPass.overrideClearColor = new three__WEBPACK_IMPORTED_MODULE_0__["Color"](0);
    this.clearPass.overrideClearAlpha = 1;
    this.edgeDetectionPass = new ShaderPass(new EdgeDetectionMaterial(new three__WEBPACK_IMPORTED_MODULE_0__["Vector2"](), edgeDetectionMode));
    ...
    searchTexture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBAFormat"];
    ...
    areaTexture.format = three__WEBPACK_IMPORTED_MODULE_0__["RGBAFormat"];
...
var SSAOEffect = class extends Effect {
  constructor(camera, normalBuffer, {
    ...
    this.renderTargetAO = new three__WEBPACK_IMPORTED_MODULE_0__["WebGLRenderTarget"](1, 1, {
      minFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"],
      magFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"],
      stencilBuffer: false,
      depthBuffer: false,
  ...
  set uvTransform(value) {
    if (this.uvTransform !== value) {
      if (value) {
        ...
        this.uniforms.get("uvTransform").value = new three__WEBPACK_IMPORTED_MODULE_0__["Matrix3"]();
        this.setVertexShader(shader_default75);
      } else {
...
var ToneMappingEffect = class extends Effect {
  constructor({
    ...
    this.renderTargetLuminance = new three__WEBPACK_IMPORTED_MODULE_0__["WebGLRenderTarget"](1, 1, {
      minFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearMipmapLinearFilter"] !== void 0 ? three__WEBPACK_IMPORTED_MODULE_0__["LinearMipmapLinearFilter"] : three__WEBPACK_IMPORTED_MODULE_0__["LinearMipMapLinearFilter"],
      magFilter: three__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"],
      stencilBuffer: false,
      depthBuffer: false,
      format: three__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"]
...
var VignetteEffect = class extends Effect {
  constructor(options = {}) {
    ...
    super("VignetteEffect", shader_default77, {
      ...
      uniforms: new Map([
        ["offset", new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](settings.offset)],
        ["darkness", new three__WEBPACK_IMPORTED_MODULE_0__["Uniform"](settings.darkness)]
      ])
    });
...
var LUT3dlLoader = class extends three__WEBPACK_IMPORTED_MODULE_0__["Loader"] {
  ...
  parse(input) {
    ...
    lut.encoding = three__WEBPACK_IMPORTED_MODULE_0__["sRGBEncoding"];
    return lut;
  }
};
...
/***/ "../../../node_modules/postprocessing/src/effects/blending/BlendFunction.js":
/*!****************************************************************************************************************!*\
  !*** /Users/coryhall/Code/FL/anonymous.club/node_modules/postprocessing/src/effects/blending/BlendFunction.js ***!
  \****************************************************************************************************************/
